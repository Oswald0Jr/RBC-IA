...
def pag_3(cur, id, objetivo, path):
    ...
    col2 = [[sg.Text('Caso Similar', background_color='dark gray'), sg.Text(f'ID: {id} Descricao: {antigo_caso["desc_doenca"]}')],
            [tabela_antigo_caso]]
    next_button= [
        [sg.Button('Continuar')],
    ]
    ...
    layout_pag3 = [
        ...
        [sg.Column(back_button, element_justification='left', expand_x=True) ,sg.Column(next_button, element_justification='right', expand_x=True),
